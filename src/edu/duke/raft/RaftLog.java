...
//	    System.out.println ("Tried to append null entry to RaftLog.");
  ...
  // @return index of last entry in log
	...
	System.exit(1);
      ...
      newEntry.term = 5;
      newEntry.action = 5;
      Entry otherEntry = new Entry(4,8);
      Entry[] betterEntries = new Entry[2];
      System.out.println("Inserting entry " + newEntry + " and " + otherEntry + " at index 0.");
      betterEntries[0] = newEntry;
      betterEntries[1] = otherEntry;
      log.insert (betterEntries, -1, -1);
      System.out.println ("Resulting RaftLog: " + log);
    }
